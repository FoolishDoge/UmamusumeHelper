const supportEvents = [
    ...
    {createDate:`2022-08-13`, character:`골드 쉽`, eventType:`support`, cardName: null, title: `부활하라! 골쉽표 소스 야키소바!`, choice: [`……맛을 다시 연구해보는 건 어때?`, `……계란 타코야키를 팔아보면 어때?`], effect: [`컨디션 상승<br>스태미나+5`, `골드 쉽의 우정도+5<br>${skill(200052)} 힌트 LV+1`]},
    ...
    {createDate:`2022-08-13`, character:`골드 쉽`, eventType:`support`, cardName: `[불침함의 진격] 골드 쉽`, title: `③ 강적이라 쓰고 『친구』라 읽는다!!`, choice: [`(선택지 없음)`], effect: [`스태미너+10<br>${skill(200341)} 힌트 LV+1`]},
    ...
    {createDate:`2022-10-22`, character:`골드 쉽`, eventType:`support`,  cardName: `[우마왕 전설・최강이 된 썰] 골드 쉽`, title: `② 골쉽 님, 던전을 찾다`, choice: [`(선택지 없음)`], effect: [`체력-15<br>스피드+5<br>스태미나+5<br>${skill(201172)} 힌트 LV+1`]},
    {createDate:`2022-10-22`, character:`골드 쉽`, eventType:`support`,  cardName: `[우마왕 전설・최강이 된 썰] 골드 쉽`, title: `③ 골쉽 님, 부하를 모으다`, choice: [`사, 사천왕?`, `전혀 모르겠어…`], effect: [`${skill(200751)} 힌트 LV+3<br>체력-10<br>스피드+10<br>스태미나+10<br>골드 쉽의 우정도+5<br>또는<br>${skill(200752)} 힌트 LV+3<br>체력-10<br>스피드+5<br>스태미나+5<br>골드 쉽의 우정도+5`, `${skill(200272)} 힌트 LV+1<br>체력+10`]},
    //골드 시티
    ...
    {createDate:`2022-08-13`, character:`골드 시티`, eventType:`support`, cardName: null, title: `13:12 / 점심시간, 기합 좀 넣어야지`, choice: [`우선은 눈앞의 일에 집중하자`, `에너지음료 마실래?`], effect: [`스킬 Pt+30<br>골드 시티의 우정도+5`, `${skill(201422)} 힌트 LV+1<br>골드 시티의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`골드 시티`, eventType:`support`, cardName: `[Run(my)way] 골드 시티`, title: `③ One Step`, hiddenTag: `원 스텝`, choice: [`(선택지 없음)`], effect: [`스태미너+10<br>${skill(200691)} 힌트 LV+1`]},
    //그래스 원더
    {createDate:`2022-08-13`, character:`그래스 원더`, eventType:`support`, cardName: null, title: `낮 무렵에 이야기를 나누다`, choice: [`동요시켜서 페이스를 무너뜨리는 게 좋아`, `철저히 마크해서 마음대로 달리지 못하게 해`], effect: [`그래스 원더의 우정도+5<br>${skill(200801)} 힌트 LV+1`, `${skill(200292)} 힌트 LV+1<br>그래스 원더의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`그래스 원더`, eventType:`support`, cardName: `[천자만홍에 섞이지 않는 한 송이] 그래스 원더`, title: `③ 숨긴다면, 꽃이어라`, choice: [`(선택지 없음)`], effect: [`성공 시 :<br>체력-10<br>스피드+5<br>근성+5<br>지능+5<br>강인한 다리 힌트 LV+1~3<br>그래스 원더의 우정도+5<br>실패 시 :<br>체력-10<br>스피드+5<br>근성+5<br>지능+5<br>${skill(200702)} 힌트 LV+1<br>그래스 원더의 우정도+5`]},
    //나리타 브라이언
    ...
    {createDate:`2022-08-13`, character:`나리타 타이신`, eventType:`support`, cardName: `[물결치는 기분] 나리타 타이신`, title: `② 인조이 뮤지컬!`, choice: [`(선택지 없음)`], effect: [`스피드+5<br>스태미너+5<br>파워+5<br>${skill(201472)} 힌트 LV+1`]},
    //나리타 탑 로드
    //나이스 네이처
    {createDate:`2022-08-13`, character:`나이스 네이처`, eventType:`support`, cardName: null, title: `(맛있는) 참견`, choice: [`무를 갈아서 같이 먹으면 페이스 업!`, `기숙사에서 튀김 파티다!`], effect: [`${skill(200462)} 힌트 LV+1<br>나이스 네이처의 우정도+5`, `컨디션 상승<br>체력 최대치+4<br>나이스 네이처의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`나이스 네이처`, eventType:`support`, cardName: `[순진천진난만] 나이스 네이처`, title: `② 뒤, 순풍을 받고`, choice: [`(선택지 없음)`], effect: [`체력+10<br>지능+5<br>${skill(200302)} 힌트 LV+3<br>나이스 네이처의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`나이스 네이처`, eventType:`support`, cardName: `[…그냥 물방울이라니까요] 나이스 네이처`, title: `② 결과는 뻔하지(그래도!)`, choice: [`(선택지 없음)`], effect: [`스태미너+5<br>근성+10<br>${skill(200762)} 힌트 LV+1`]},
    ...
    //나카야마 페스타
    {createDate:`2023-02-08`, character:`나카야마 페스타`, eventType:`support`, cardName: `[43, 8, 1] 나카야마 페스타`, title: `① 전조의 밤`, choice: [`그냥 넘어갈 수 없어! 내가 널 대신할게!`, `전력으로 도망간다!`], effect: [`스태미나+10<br>근성+5<br>스킬 Pt+10<br>나카야마 페스타의 우정도+5<br>※ 선택지에 따라 연속 이벤트 3이 분기`, `체력-10<br>스킬 Pt+5<br>나카야마 페스타의 우정도+5<br>※ 선택지에 따라 연속 이벤트 3이 분기`]},
    ...
    {createDate:`2022-08-13`, character:`니시노 플라워`, eventType:`support`, cardName: `[당신에게 바친다] 니시노 플라워`, title: `② 고맙다는 말을 하고 싶어서…!`, choice: [`화관을 주려고 서둘렀구나`, `감사의 화관이라니 좋네`], effect: [`파워+5<br>${skill(200362)} 힌트 LV+1<br>니시노 플라워의 우정도+5`, `지능+5<br>${skill(200372)} 힌트 LV+1<br>니시노 플라워의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`니시노 플라워`, eventType:`support`, cardName: `[아직 작은 꽃봉오리지만] 니시노 플라워`, title: `③ 소중한 것은!`, choice: [`(선택지 없음)`], effect: [`스피드+5<br>지능+10<br>한줄기 질풍 힌트 LV+1~3<br>또는<br>스피드+5<br>지능+10<br>${skill(200362)} 힌트 LV+1`]},
    //다이와 스칼렛
    ...
    {createDate:`2022-08-13`, character:`다이와 스칼렛`, eventType:`support`, cardName: null, title: `이 정도는 괜찮다니까!`, choice: [`테이핑 해줄까?`, `혹시 모르니 양호실에 가자!`], effect: [`다이와 스칼렛의 우정도+5<br>${skill(200562)} 힌트 LV+1`, `체력+20<br>컨디션 상승<br>다이와 스칼렛의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`다이와 스칼렛`, eventType:`support`, cardName: `[노력은 배신하지 않아!] 다이와 스칼렛`, title: `② 청소도 질 수는 없지!`, choice: [`(선택지 없음)`], effect: [`지능+10<br>${skill(201362)} 힌트 LV+1`]},
    ...
    {createDate:`2022-11-17`, character:`다이와 스칼렛`, eventType:`support`,  cardName: `[트라이플☆버케이션] 다이와 스칼렛`, title: `③ 놀아 보자☆풀사이드`, choice: [`(선택지 없음)`], effect: [`체력-5<br>파워+10<br>${skill(200571)} 힌트 LV+3<br>또는<br>체력-5<br>파워+5<br>${skill(200572)} 힌트 LV+3`]},
    //다이이치 루비
    //다이타쿠 헬리오스
    {createDate:`2022-08-13`, character:`다이타쿠 헬리오스`, eventType:`support`, cardName: null, title: `미소 포에버`, choice: [`기합으로 참아!`, `일단 진정하자`], effect: [`스피드+5<br>파워+10<br>다이타쿠 헬리오스의 우정도+5`, `다이타쿠 헬리오스의 우정도+5<br>${skill(200302)} 힌트 LV+1`]},
    ...
    {createDate:`2022-08-13`, character:`라이스 샤워`, eventType:`support`, cardName: null, title: `흐린 날의 1페이지`, choice: [`체육관을 빌려서 달리자!`, `햇빛 쨍쨍 인형을 만들자!`], effect: [`스피드+5<br>근성+5<br>라이스 샤워의 우정도+5`, `${skill(200152)} 힌트 LV+1<br>라이스 샤워의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`라이스 샤워`, eventType:`support`, cardName: `[『행복』이 흩날릴 때] 라이스 샤워`, title: `③ 둘이서 노력한 날의 1페이지`, choice: [`(선택지 없음)`], effect: [`성공 시 :<br>체력-10<br>스태미너+5<br>근성+5<br>${skill(200761)} 힌트 LV+3<br>라이스 샤워의 우정도+5<br>실패 시 :<br>체력-10<br>${skill(200762)} 힌트 LV+1<br>라이스 샤워의 우정도+5`]},
    {createDate:`2022-12-19`, character:`라이스 샤워`, eventType:`support`,  cardName: `[행복은 모퉁이 저편] 라이스 샤워`, title: `① 비 오는 날, 둥실둥실, 꽃밭`, choice: [`긍정적으로 생각하자!`, `행복은 가까이에서 굴러다니는 걸지도 몰라`], effect: [`파워+10<br>라이스 샤워의 우정도+5`, `${skill(201202)} 힌트 LV+1<br>스킬 Pt+40<br>※ 다음 이벤트가 발생하지 않음`]},
    {createDate:`2022-12-19`, character:`라이스 샤워`, eventType:`support`,  cardName: `[행복은 모퉁이 저편] 라이스 샤워`, title: `② 계~속, 반들반들, 마법의 꽃`, choice: [`다 되면 보여줘!`, `다음에 직접 만드는 게 기대되네!`], effect: [`스태미나+5<br>파워+10<br>라이스 샤워의 우정도+5`, `체력+15<br>파워+5<br>라이스 샤워의 우정도+5`]},
    {createDate:`2022-12-19`, character:`라이스 샤워`, eventType:`support`,  cardName: `[행복은 모퉁이 저편] 라이스 샤워`, title: `③ 맑은 날, 팔랑팔랑, 꽃다발을`, choice: [`(선택지 없음)`], effect: [`스태미나+5<br>파워+5<br>지능+5<br>${skill(200351)} 힌트 LV+1<br>라이스 샤워의 우정도+5`]},
    //마루젠스키
    {createDate:`2022-08-13`, character:`마루젠스키`, eventType:`support`, cardName: `[트레센 학원] 마루젠스키`, title: `귀여운 후배를 위해서인걸`, choice: [`무릎을 쓰는 방법을 가르쳐 준다`, `기초 체력을 늘린다`], effect: [`${skill(200532)} 힌트 LV+1`, `체력+5<br>스피드+10`]},
    {createDate:`2022-08-13`, character:`마루젠스키`, eventType:`support`, cardName: `[트레센 학원] 마루젠스키`, title: `알흠다운 드라이브랍니다~`, choice: [`해안`, `모르는 거리`], effect: [`${skill(200232)} 힌트 LV+1`, `컨디션 상승<br>지능+5`]},
    //마블러스 선데이
    {createDate:`2022-08-13`, character:`마블러스 선데이`, eventType:`support`, cardName: null, title: `Marvelous하게 만들려면☆`, hiddenTag: `마블러스`, choice: [`직접 전력을 다해서 부딪혀 본다든가…?`, `간사이 출신처럼 말해 본다든가…?`], effect: [`체력+10<br>컨디션 상승<br>마블러스 선데이의 우정도+5`, `${skill(200052)} 힌트 LV+1<br>마블러스 선데이의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`마야노 탑건`, eventType:`support`, cardName: null, title: `마야노식 패션 회의!`, choice: [`최신 유행의 센스 극강 코디!`, `움직이기 편한 기능성 코디!`], effect: [`마야노 탑건의 우정도+5<br>${skill(200362)} 힌트 LV+1`, `스태미나+10<br>마야노 탑건의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`마야노 탑건`, eventType:`support`, cardName: `[귀여움+귀여움은~?] 마야노 탑건`, title: `② 트렌드로 테이크 오프♪`, choice: [`(선택지 없음)`], effect: [`스태미너+10<br>스킬 Pt+15<br>${skill(200432)} 힌트 LV+1<br>마야노 탑건의 우정도+5`]},
    //마치카네 탄호이저
    ...
    {createDate:`2022-08-13`, character:`마치카네 탄호이저`, eventType:`support`, cardName: `[Just keep going.] 마치카네 탄호이저`, title: `③ 개성적인 달리기 방법?`, choice: [`(선택지 없음)`], effect: [`파워+5<br>스킬 Pt+10<br>${skill(200482)} 힌트 LV+3<br>마치카네 탄호이저의 우정도+5<br>또는<br>파워+10<br>스킬 Pt+15<br>${skill(200481)} 힌트 LV+3<br>마치카네 탄호이저의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`마치카네 탄호이저`, eventType:`support`, cardName: null, title: `이것도 평범한 해프닝!?`, choice: [`힘찬 달리기였어!`, `망설임 없는 달리기였어!`], effect: [`스태미나+5<br>근성+10<br>마치카네 탄호이저의 우정도+5`, `마치카네 탄호이저의 우정도+5<br>${skill(200831)} 힌트 LV+1`]},
    //마치카네 후쿠키타루
    ...
    {createDate:`2022-08-13`, character:`마치카네 후쿠키타루`, eventType:`support`, cardName: `[운의 행방] 마치카네 후쿠키타루`, title: `② 지도와 친구`, choice: [`모두를 믿어!`, `기분전환으로 한번 달릴래?`], effect: [`스킬 Pt+45<br>마치카네 후쿠키타루의 우정도+5`, `체력+10<br>컨디션 상승<br>${skill(200012)} 힌트 LV+3<br>마치카네 후쿠키타루의 우정도+5<br>실패 시 :<br>체력-20<br>${skill(200012)} 힌트 LV+1`]},
    //맨하탄 카페
    {createDate:`2022-08-13`, character:`맨하탄 카페`, eventType:`support`, cardName: null, title: `고요함을 즐기다`, choice: [`쉬는 시간이었어?`, `혼자 어두운 곳에 있어도 안 무섭나 보다`], effect: [`스태미나+5<br>스킬 Pt+15<br>맨하탄 카페의 우정도+5`, `${skill(200142)} 힌트 LV+1<br>맨하탄 카페의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`맨하탄 카페`, eventType:`support`, cardName: `[비의 독주, 나의 독창] 맨하탄 카페`, title: `② 큰비의 유혹`, choice: [`(선택지 없음)`], effect: [`스태미너+15<br>${skill(201432)} 힌트 LV+1<br>맨하탄 카페의 우정도+5`]},
    //메이쇼 도토
    {createDate:`2022-08-13`, character:`메이쇼 도토`, eventType:`support`, cardName: null, title: `당근… 사 주세요`, choice: [`트레센 학원과 거래해 보자`, `사람이 많은 곳에서 홍보해 보자`], effect: [`체력+10<br>지능+5<br>메이쇼 도토의 우정도+5`, `${skill(201322)} 힌트 LV+1<br>메이쇼 도토의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`메이쇼 도토`, eventType:`support`, cardName: `[행복을 등지고] 메이쇼 도토`, title: `② 내가, 바라는 것…`, choice: [`(선택지 없음)`], effect: [`체력+10<br>컨디션 상승<br>스킬 Pt+15<br>${skill(200582)} 힌트 LV+1`]},
    //메지로 도베르
    {createDate:`2022-08-13`, character:`메지로 도베르`, eventType:`support`, cardName: null, title: `기뻐해 줄까…`, choice: [`다른 선물을 찾아보는 건 어때?`, `각오를 다지고, 돌진하자!`], effect: [`스킬 Pt+45<br>메지로 도베르의 우정도+5`, `${skill(201072)} 힌트 LV+1<br>메지로 도베르의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`메지로 도베르`, eventType:`support`, cardName: `[시선은 신경 쓰지 말고] 메지로 도베르`, title: `② 보여졌대도`, choice: [`(선택지 없음)`], effect: [`체력+20<br>스태미너+15<br>${skill(200602)} 힌트 LV+1<br>또는<br>체력+5<br>스태미너+5<br>${skill(200602)} 힌트 LV+1`]},
    ...
    {createDate:`2022-09-16`, character:`메지로 도베르`, eventType:`support`,  cardName: `[마음, 바라다] 메지로 도베르`, title: `③ 세 걸음 나아가, 두 걸음 물러서서, 한 걸음`, choice: [`(선택지 없음)`], effect: [`체력-10<br>근성+5<br>지능+5<br>${skill(201431)} 힌트 LV+1`]},
    //메지로 라모누
    //메지로 라이언
    ...
    {createDate:`2022-08-13`, character:`메지로 라이언`, eventType:`support`, cardName: null, title: `어디까지나 추천받았을 뿐`, choice: [`페이스를 고려하는 게 좋아`, `몰아 읽는 건 체력이 꽤 드는데?`], effect: [`메지로 라이언의 우정도+5<br>${skill(200472)} 힌트 LV+1`, `체력+30<br>메지로 라이언의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`메지로 라이언`, eventType:`support`, cardName: `[단련하고, 화답하고!] 메지로 라이언`, title: `② 응원을 받아들이는 마음`, choice: [`(선택지 없음)`], effect: [`파워+15<br>${skill(200492)} 힌트 LV+1<br>메지로 라이언의 우정도+5`]},
    {createDate:`2022-11-05`, character:`메지로 라이언`, eventType:`support`,  cardName: `[상쾌! 위닝 샷!] 메지로 라이언`, title: `① 허둥지둥 오후의 차!`, choice: [`너희가 나누어 먹으면 다 먹을 수 있어!`, `테이크아웃할래?`], effect: [`체력+10<br>컨디션 상승`, `${skill(201532)} 힌트 LV+3<br>지능+10<br>스킬 Pt+15<br>※ 다음 이벤트가 발생하지 않음`]},
    ...
    {createDate:`2022-11-05`, character:`메지로 라이언`, eventType:`support`,  cardName: `[상쾌! 위닝 샷!] 메지로 라이언`, title: `③ 불굴의 버닝 하트!!`, choice: [`(선택지 없음)`], effect: [`${skill(200731)} 힌트 LV+1<br>파워+10<br>근성+5`]},
    //메지로 맥퀸
    ...
    {createDate:`2022-08-13`, character:`메지로 맥퀸`, eventType:`support`, cardName: null, title: `정점에 다다르기 위해`, choice: [`스태미나와 근성을 키우자`, `스타트 대시를 의식하자`], effect: [`스태미나+5<br>근성+5<br>메지로 맥퀸의 우정도+5`, `${skill(200532)} 힌트 LV+1<br>메지로 맥퀸의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`메지로 맥퀸`, eventType:`support`, cardName: `[『에이스』로서] 메지로 맥퀸`, title: `③ '기대'에 부응하다`, choice: [`(선택지 없음)`], effect: [`체력-10<br>스태미너+10<br>${skill(200741)} 힌트 LV+3<br>또는<br>체력-10<br>${skill(200742)} 힌트 LV+1`]},
    //메지로 브라이트
    //메지로 아르당
    ...
    {createDate:`2022-11-05`, character:`메지로 아르당`, eventType:`support`,  cardName: null, title: `유리 소녀는 놀고 싶다`, choice: [`『카루타』는 어때?`, `영상을 찍어서 우마톡에 올려보는 건 어때?`], effect: [`스피드+10<br>지능+10<br>메지로 아르당의 우정도+5`, `${skill(200881)} 힌트 LV+1<br>메지로 아르당의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`메지로 파머`, eventType:`support`, cardName: null, title: `포지티브한 도주`, choice: [`고마워. 그렇지만 아직 더 노력하고 싶어.`, `그럼 나도 도주해 볼게!`], effect: [`근성+15<br>메지로 파머의 우정도+5`, `메지로 파머의 우정도+5<br>${skill(200162)} 힌트 LV+1`]},
    ...
    {createDate:`2022-08-13`, character:`메지로 파머`, eventType:`support`, cardName: `[바보라고 비웃어 봐] 메지로 파머`, title: `② 사랑의 도주 이스케이프`, choice: [`사랑은 중요하지!`, `일상과는 다른 체험을 통해 성장하는 건 맞을지도`], effect: [`체력+10<br>근성+5<br>지능+5<br>메지로 파머의 우정도+5`, `체력+10<br>메지로 파머의 우정도+5<br>${skill(201522)} 힌트 LV+1`]},
    {createDate:`2022-08-13`, character:`메지로 파머`, eventType:`support`, cardName: `[바보라고 비웃어 봐] 메지로 파머`, title: `③ 포지티브 도주 네버 기브업!`, choice: [`좋은 콤비구나`, `너의 “도주”는 성장욕구구나`], effect: [`성공 시 :<br>체력-10<br>스태미나+20<br>근성+20<br>${skill(201191)} 힌트 LV+3<br>메지로 파머의 우정도+5<br>실패 시 :<br>체력-10<br>스태미나+5<br>근성+5<br>${skill(201192)} 힌트 LV+3<br>메지로 파머의 우정도+5`, `체력+10<br>${skill(201641)} 힌트 LV+1`]},
    //미스터 시비
    //미호노 부르봉
    {createDate:`2022-08-13`, character:`미호노 부르봉`, eventType:`support`, cardName: null, title: `명령은 지켜야만 한다`, choice: [`문 열기 전부터 기다리자`, `점심시간 종 치자마자 달려!`], effect: [`미호노 부르봉의 우정도+5<br>${skill(200432)} 힌트 LV+1`, `스피드+10<br>스킬 Pt+15<br>미호노 부르봉의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`미호노 부르봉`, eventType:`support`, cardName: `[친구를 철저히 단련] 미호노 부르봉`, title: `① 사이보그가 아닙니다`, choice: [`표정 훈련을 하자!`, `억양을 붙여서 말하자!`], effect: [`근성+10<br>스킬 Pt+15<br>미호노 부르봉의 우정도+5`, `체력-10<br>${skill(200352)} 힌트 LV+1<br>랜덤으로 미호노 부르봉의 우정도-5<br>※다음 이벤트가 발생하지 않음`]},
    {createDate:`2022-08-13`, character:`미호노 부르봉`, eventType:`support`, cardName: `[친구를 철저히 단련] 미호노 부르봉`, title: `② 새로운 가치관 인스톨`, choice: [`(선택지 없음)`], effect: [`체력-10<br>파워+5<br>근성+5<br>${skill(201242)} 힌트 LV+1<br>미호노 부르봉의 우정도+5`]},
    ...
    {createDate:`2022-12-30`, character:`미호노 부르봉`, eventType:`support`,  cardName: `[축복은 푸가] 미호노 부르봉`, title: `③ 단짝☆친구 ~실천편~`, choice: [`(선택지 없음)`], effect: [`${skill(200551)} 힌트 LV+3<br>스태미나+10<br>미호노 부르봉의 우정도+5<br>또는<br>${skill(200552)} 힌트 LV+3<br>스태미나+5<br>미호노 부르봉의 우정도+5`]},
    {createDate:`2023-01-18`, character:`미호노 부르봉`, eventType:`support`, cardName: `[유령과 할로윈의 마법] 미호노 부르봉`, title: `① 스테이터스 『재미없음?』`, choice: [`지금 이대로가 좋아!`, `표정을 바꾸지 않아도 되는 컨셉이면 어때?`], effect: [`스피드+10<br>미호노 부르봉의 우정도+5<br>${skill(201282)} 힌트 LV+1`, `지능+15<br>미호노 부르봉의 우정도+5`]},
    ...
    {createDate:`2023-01-18`, character:`미호노 부르봉`, eventType:`support`, cardName: `[유령과 할로윈의 마법] 미호노 부르봉`, title: `③ 스테이터스 『재밌어!』`, choice: [`(선택지 없음)`], effect: [`스태미나+5<br>지능+10<br>${skill(200531)} 힌트 LV+1`]},
    //뱀부 메모리
    {createDate:`2022-10-11`, character:`뱀부 메모리`, eventType:`support`,  cardName: `[Head-on fight!] 뱀부 메모리`, title: `① 목표는 득점왕임다!`, choice: [`(선택지 없음)`], effect: [`체력-10<br>스태미나+3<br>파워+3<br>근성+3<br>${skill(200282)} 힌트 LV+1`]},
    {createDate:`2022-10-11`, character:`뱀부 메모리`, eventType:`support`,  cardName: `[Head-on fight!] 뱀부 메모리`, title: `② 상대가 누구든 교칙은 절대적임다!`, choice: [`아무튼 이제 안심이군`, `명콤비였군`, `……만약 유령이 겁내지 않으면?`], effect: [`체력 최대치+4<br>체력-10<br>스태미나+10<br>파워+10<br>근성+5<br>뱀부 메모리의 우정도+5<br><br>또는<br><br>체력-20<br>스태미나+10<br>파워+10<br>근성+5<br>뱀부 메모리의 우정도+5<br><br>또는<br><br>체력-20<br>스태미나+10<br>근성+10<br>${skill(200521)} 획득<br>${skill(200512)} 힌트 LV+1`, `체력-10<br>컨디션 상승<br>스태미나+5<br>파워+5<br>뱀부 메모리의 우정도+5`, `체력+30<br>${skill(200911)} 힌트 LV+1<br>연속 이벤트 종료`]},
    {createDate:`2022-10-11`, character:`뱀부 메모리`, eventType:`support`,  cardName: `[Head-on fight!] 뱀부 메모리`, title: `③ 언젠가 강적이라 부를 수 있는 날을 위해! 임다!`, choice: [`(선택지 없음)`], effect: [`체력 최대치+4<br>스태미나+10<br>파워+15<br>${skill(200611)} 힌트 LV+3<br>뱀부 메모리의 우정도+5<br><br>또는<br><br>체력-15<br>스태미나+10<br>파워+15<br>${skill(200612)} 힌트 LV+3`]},
    ...
    {createDate:`2022-10-11`, character:`뱀부 메모리`, eventType:`support`,  cardName: null, title: `트러블, 문제없슴다!`, choice: [`교칙 단속도 힘들구나`, `현장으로 출동!`], effect: [`스태미나+5<br>근성+5<br>뱀부 메모리의 우정도+5`, `${skill(200132)} 힌트 LV+5<br>체력-10<br>뱀부 메모리의 우정도+5`]},
    //보드카
    {createDate:`2022-08-13`, character:`보드카`, eventType:`support`, cardName: null, title: `길거리의 강적`, choice: [`샛길로 간다`, `전력 질주로 지나간다`], effect: [`${skill(200492)} 힌트 LV+1<br>보드카의 우정도+5`, `파워+5<br>스킬 Pt+15<br>보드카의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`보드카`, eventType:`support`, cardName: `[로드 · 오브 · 보드카] 보드카`, title: `③ 기록으로 남겨둬`, choice: [`(선택지 없음)`], effect: [`파워+5<br>스킬 Pt+30<br>${skill(200381)} 힌트 LV+1`]},
    //비와 하야히데
    ...
    {createDate:`2022-08-13`, character:`비와 하야히데`, eventType:`support`, cardName: null, title: `탈 무난론`, choice: [`머리로 생각하기보다 먼저 행동해 보자`, `다치면 다 소용없어`], effect: [`체력-10<br>비와 하야히데의 우정도+5<br>${skill(200752)} 힌트 LV+1`, `체력+10<br>스태미나+10<br>비와 하야히데의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`비와 하야히데`, eventType:`support`, cardName: `[검증, 개시] 비와 하야히데`, title: `② 트레이닝은 이론적으로`, choice: [`(선택지 없음)`], effect: [`체력-10<br>스태미너+5<br>파워+15<br>${skill(201212)} 힌트 LV+3<br>또는<br>체력-20<br>파워+5<br>${skill(201212)} 힌트 LV+1`]},
    ...
    {createDate:`2022-12-30`, character:`비와 하야히데`, eventType:`support`,  cardName: `[함께 울리는 스트레인] 비와 하야히데`, title: `② 약간 진하게, 딱딱하게, 왕 곱빼기`, choice: [`(선택지 없음)`], effect: [`성공 시 :<br>${skill(200352)} 힌트 LV+1<br>스킬 Pt+10<br>실패 시 :<br>스킬 Pt+10`]},
    {createDate:`2022-12-30`, character:`비와 하야히데`, eventType:`support`,  cardName: `[함께 울리는 스트레인] 비와 하야히데`, title: `③ 친구가 준 것`, choice: [`(선택지 없음)`], effect: [`${skill(200741)} 힌트 LV+1<br>파워+5<br>지능+5<br>비와 하야히데의 우정도+5`]},
    //비코 페가수스
    {createDate:`2022-08-13`, character:`비코 페가수스`, eventType:`support`, cardName: null, title: `필살기를 손에 넣어라!`, choice: [`스트라이크, 멋있겠다`, `무리는 하지 마`], effect: [`비코 페가수스의 우정도+5<br>${skill(200962)} 힌트 LV+1`, `체력+30<br>비코 페가수스의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`비코 페가수스`, eventType:`support`, cardName: `[필살! 더블 캐럿 펀치!] 비코 페가수스`, title: `③ 결전! 영광의 승리를 이 손에!`, choice: [`(선택지 없음)`], effect: [`스피드+5<br>파워+5<br>근성+5<br>${skill(200991)} 힌트 LV+1`]},
    //사일런스 스즈카
    ...
    {createDate:`2022-08-13`, character:`사일런스 스즈카`, eventType:`support`, cardName: null, title: `어쩌면 좋지`, choice: [`함께 병합 훈련해주는 건 어때?`, `그 좌회전에 비결이 숨겨져 있을지도 몰라`], effect: [`스피드+5<br>스태미나+5<br>지능+5<br>사일런스 스즈카의 우정도+5`, `${skill(200022)} 힌트 LV+1<br>사일런스 스즈카의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`사일런스 스즈카`, eventType:`support`, cardName: `[빛나는 경치, 그 너머에] 사일런스 스즈카`, title: `③ 편지→모두의 마음→기다리고 있어줘`, choice: [`(선택지 없음)`], effect: [`스피드+10<br>${skill(200551)} 힌트 LV+1`]},
    {createDate:`2022-12-16`, character:`사일런스 스즈카`, eventType:`support`,  cardName: `[WINNING DREAM] 사일런스 스즈카`, title: `① 연주하자 WINNING!`, hiddenTag: `위닝`, choice: [`친목회!!`, `몸을 움직이면 연습도 될 거야`], effect: [`${skill(201352)} 힌트 LV+1<br>근성+10`, `${skill(201142)} 힌트 LV+1<br>스피드+10`]},
    ...
    {createDate:`2022-12-16`, character:`사일런스 스즈카`, eventType:`support`,  cardName: `[WINNING DREAM] 사일런스 스즈카`, title: `③ 울려 퍼지는 Stage!`, hiddenTag: `스테이지`, choice: [`(선택지 없음)`], effect: [`스피드+5<br>스태미나+5<br>${skill(200431)} 힌트 LV+1`]},
    //사쿠라 로렐
    //사쿠라 바쿠신 오
    {createDate:`2022-08-13`, character:`사쿠라 바쿠신 오`, eventType:`support`, cardName: null, title: `뛰고 싶어질 정도로!!`, choice: [`다 읽으면 빌려도 될까?`, `참고하게 달리기를 보여줄 있어?`], effect: [`사쿠라 바쿠신 오의 우정도+5<br>${skill(200672)} 힌트 LV+1`, `체력-10<br>스피드+10<br>파워+5<br>사쿠라 바쿠신 오의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`사쿠라 바쿠신 오`, eventType:`support`, cardName: `[빠르다! 맛있다! 빠르다!] 사쿠라 바쿠신 오`, title: `③ 바쿠신의 대성공!!`, choice: [`(선택지 없음)`], effect: [`스피드+10<br>파워+5<br>${skill(200651)} 힌트 LV+1`]},
    //사쿠라 치요노 오
    ...
    {createDate:`2022-09-05`, character:`사쿠라 치요노 오`, eventType:`support`,  cardName: `[바야흐로 한창인 벚꽃] 사쿠라 치요노 오`, title: `③ 꽃 피는, 언젠가!`, choice: [`결과는 금방 나오지 않아`, `이제 극복하는 건 포기할까?`], effect: [`성공 시 :<br>체력-15<br>스태미나+30<br>스킬 Pt+20<br>${skill(200581)} 힌트 LV+3<br>사쿠라 치요노 오의 우정도+5<br>실패 시 :<br>체력-15<br>스태미나+10<br>스킬 Pt+5<br>${skill(200582)} 힌트 LV+3<br>사쿠라 치요노 오의 우정도+5`, `스피드+5<br>스태미나+10<br>파워+5<br>스킬 Pt+30<br>사쿠라 치요노 오의 우정도+5`]},
    {createDate:`2022-09-05`, character:`사쿠라 치요노 오`, eventType:`support`,  cardName: null, title: `언젠가 피는, 그날까지…`, choice: [`자신다움도 중요하지 않을까`, `꼭 될 수 있어!`], effect: [`체력+5<br>스태미나+5<br>사쿠라 치요노 오의 우정도+5`, `${skill(200172)} 힌트 LV+1<br>사쿠라 치요노 오의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`사토노 다이아몬드`, eventType:`support`, cardName: `[그 뒷모습을 넘어서] 사토노 다이아몬드`, title: `③ 당신에게만큼은 절대로`, choice: [`소등시간까지 지켜본다`, `살며시 그 장소에서 떠난다`], effect: [`체력-20<br>스태미나+30<br>${skill(200441)} 힌트 LV+1<br>사토노 다이아몬드의 우정도+5`, `체력+5<br>근성+5<br>사토노 다이아몬드의 우정도+5<br>${skill(200441)} 힌트 LV+1`]},
    ...
    {createDate:`2022-08-13`, character:`사토노 다이아몬드`, eventType:`support`, cardName: null, title: `어려운 일, 정말 좋아해요!`, choice: [`좋아, 해보자!`, `우선 어떤 건지 한번 보고 결정하자`], effect: [`스태미나+5<br>근성+10<br>사토노 다이아몬드의 우정도+5`, `사토노 다이아몬드의 우정도+5<br>${skill(200851)} 힌트 LV+1`]},
    //사토노 크라운
    //세이운 스카이
    ...
    {createDate:`2022-08-13`, character:`세이운 스카이`, eventType:`support`, cardName: null, title: `느긋하게 모집, 조언자`, choice: [`자리가 안 좋은 걸지도`, `낚싯대 쓰는 방식을 바꿔 보면 어떨까?`], effect: [`지능+15<br>세이운 스카이의 우정도+5`, `${skill(201192)} 힌트 LV+1<br>세이운 스카이의 우정도+5`]},
    ...
    {createDate:`2022-10-22`, character:`세이운 스카이`, eventType:`support`,  cardName: `[내일은 전국이 저기압이겠습니다♪] 세이운 스카이`, title: `② 갑작스러운 머더 미스터리! 2`, choice: [`청소도구를 들고 있었다든가?`, `그건 그렇고, 정말로 평범한 청소부…?`], effect: [`${skill(200801)} 힌트 LV+1<br>지능+5<br>세이운 스카이의 우정도+5`, `체력+5<br>스킬 Pt+10<br>세이운 스카이의 우정도+5`]},
    {createDate:`2022-10-22`, character:`세이운 스카이`, eventType:`support`,  cardName: `[내일은 전국이 저기압이겠습니다♪] 세이운 스카이`, title: `③ 갑작스러운 머더 미스터리! 3`, choice: [`세이운 스카이가 범인`, `그래스 원더가 범인`], effect: [`성공시:<br>${skill(201191)} 힌트 LV+3<br>지능+10<br><br>실패시:<br>${skill(201191)} 힌트 LV+1<br>세이운 스카이의 우정도+5<br>지능+5<br>세이운 스카이의 우정도+5`, `체력+10<br>스태미나+10<br>스킬 Pt+15`]},
    {createDate:`2022-08-13`, character:`세이운 스카이`, eventType:`support`, cardName: `[대망의 큰 그림] 세이운 스카이`, title: `① 이용은 전략적으로☆`, choice: [`세이운 스카이한테 동의한다`, `궤변이라고 말한다`], effect: [`체력+10<br>지능+5<br>세이운 스카이의 우정도+5`, `스킬 Pt+30<br>세이운 스카이의 우정도-5<br>연속 이벤트 종료<br>${skill(201292)} 힌트 LV+1`]},
    ...
    {createDate:`2022-08-13`, character:`세이운 스카이`, eventType:`support`, cardName: `[대망의 큰 그림] 세이운 스카이`, title: `③ 모든 것은 이기기 위해서`, choice: [`(선택지 없음)`], effect: [`체력+10<br>컨디션 상승<br>스피드+5<br>스태미너+5<br>지능+5<br>스킬 Pt+5<br>${skill(200541)} 힌트 LV+1~3<br>또는<br>체력+10<br>컨디션 상승<br>스피드+5<br>스태미너+5<br>지능+5<br>스킬 Pt+5<br>${skill(200542)} 힌트 LV+1`]},
    //슈발 그랑
    //슈퍼 크릭
    ...
    {createDate:`2022-08-13`, character:`슈퍼 크릭`, eventType:`support`, cardName: null, title: `배려도 맡겨주세요♪`, choice: [`더 응원한다`, `음료수를 건넨다`], effect: [`슈퍼 크릭의 우정도+5<br>${skill(200742)} 힌트 LV+1`, `체력+10<br>스태미나+5<br>슈퍼 크리크의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`슈퍼 크릭`, eventType:`support`, cardName: `[한 알의 평온] 슈퍼 크릭`, title: `③ 더 드셔도 돼요, 착하지 착해!`, choice: [`(선택지 없음)`], effect: [`스태미너+10<br>파워+5<br>${skill(200351)} 힌트 LV+1`]},
    //스마트 팔콘
    {createDate:`2022-08-13`, character:`스마트 팔콘`, eventType:`support`, cardName: null, title: `귀여웠으면 보러 와 줘☆`, choice: [`도망친다`, `다운로드 해본다`], effect: [`체력-10<br>파워+10<br>스마트 팔콘의 우정도+5<br>${skill(200552)} 힌트 LV+1`, `체력+10<br>지능+5<br>스마트 팔콘의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`스마트 팔콘`, eventType:`support`, cardName: `[이것이 나의 우마돌의 길☆] 스마트 팔콘`, title: `① 항상 마음에 무대를☆`, choice: [`공부도 열심히 하자`, `꿈을 위해 힘내라!`], effect: [`지능+10<br>스마트 팔콘의 우정도+5`, `체력+25<br>스마트 팔콘의 우정도+5<br>연속 이벤트 종료<br>${skill(200432)} 힌트 LV+1`]},
    ...
    {createDate:`2022-08-13`, character:`스마트 팔콘`, eventType:`support`, cardName: `[이것이 나의 우마돌의 길☆] 스마트 팔콘`, title: `③ 이것이 나의 우마돌 길☆`, choice: [`(선택지 없음)`], effect: [`체력 최대치+4<br>스태미너+5<br>파워+5<br>지능+5<br>${skill(200451)} 힌트 LV+3<br>또는<br>체력 최대치+4<br>스태미너+5<br>파워+5<br>지능+5<br>${skill(200452)} 힌트 LV+1`]},
    //스윕 토쇼
    ...
    {createDate:`2022-08-13`, character:`스윕 토쇼`, eventType:`support`, cardName: `[견습 마녀와 긴 밤] 스윕 토쇼`, title: `① 비장의 친구?`, choice: [`야채는 먹는 게 좋아`, `하고 싶은 대로 하면 돼`], effect: [`스피드+5<br>스킬 Pt+10<br>스윕 토쇼의 우정도+5<br>${skill(201562)} 힌트 LV+1`, `컨디션 하락<br>${skill(200272)} 힌트 LV+5`]},
    {createDate:`2022-08-13`, character:`스윕 토쇼`, eventType:`support`, cardName: `[견습 마녀와 긴 밤] 스윕 토쇼`, title: `② 장난은 계획적으로`, choice: [`후지 키세키를 생각해서 한 일이지?`, `솔직히 말하고 사과하는 편이 좋을걸`], effect: [`스피드+10<br>스킬 Pt+20<br>스윕 토쇼의 우정도+5<br>${skill(201492)} 힌트 LV+1`, `컨디션 하락<br>${skill(201641)} 힌트 LV+1`]},
    {createDate:`2022-11-17`, character:`스윕 토쇼`, eventType:`support`,  cardName: `[차가운 독점?] 스윕 토쇼`, title: `① 변덕쟁이 천재 마법소녀 스위피☆`, choice: [`좋아, 가라!`, `잠깐…!!`], effect: [`성공 시 :<br>${skill(200642)} 힌트 LV+2<br>컨디션 상승<br>스윕 토쇼의 우정도+5<br>실패 시 :<br>컨디션 하락<br>지능+5<br>스윕 토쇼의 우정도+5`, `스킬 Pt+15<br>스윕 토쇼의 우정도+5`]},
    ...
    {createDate:`2022-11-17`, character:`스윕 토쇼`, eventType:`support`,  cardName: `[차가운 독점?] 스윕 토쇼`, title: `③ 소녀의 기분은 꽃처럼 변한다☆彡`, choice: [`(선택지 없음)`], effect: [`스피드+5<br>지능+5<br>${skill(201501)} 힌트 LV+1`]},
    //스페셜 위크
    {createDate:`2022-08-13`, character:`스페셜 위크`, eventType:`support`, cardName: null, title: `모퉁이에선 조심할게요!`, choice: [`지금 힘을 다 안 쓰는 게 좋아`, `서둘러 가봐`], effect: [`스페셜 위크의 우정도+5<br>${skill(200762)} 힌트 LV+1`, `근성+15<br>스페셜 위크의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`스페셜 위크`, eventType:`support`, cardName: `[일본 최고의 무대를] 스페셜 위크`, title: `③ 우리의 빅토리 스탠드!`, choice: [`(선택지 없음)`], effect: [`성공 시 :<br>체력-10<br>스피드+5<br>스태미너+5<br>근성+15<br>${skill(200511)} 힌트 LV+3<br>스페셜 위크의 우정도+5<br>실패 시 :<br>체력-10<br>스피드+5<br>스태미너+5<br>근성+5<br>${skill(200512)} 힌트 LV+1<br>스페셜 위크의 우정도+5`]},
    ...
    {createDate:`2022-09-05`, character:`시킹 더 펄`, eventType:`support`,  cardName: `[세계의 진주, 그 이름은] 시킹 더 펄`, title: `① 말은 논논♪ 바디로 표현하는 거야!`, choice: [`소리 높여 노래한다`, `스트레스를 발산하며 춤춘다`, `만족스러운 포즈를 취한다`], effect: [`컨디션 상승<br>${skill(201562)} 힌트 LV+1<br>시킹 더 펄의 우정도+5`, `파워+10<br>근성+10<br>시킹 더 펄의 우정도+5`, `체력+30<br>※다음 이벤트가 발생하지 않음`]},
    {createDate:`2022-09-05`, character:`시킹 더 펄`, eventType:`support`,  cardName: `[세계의 진주, 그 이름은] 시킹 더 펄`, title: `② 포기하지 마! 가능성은 무한대!`, choice: [`(선택지 없음)`], effect: [`파워+5<br>근성+5<br>${skill(201052)} 힌트 LV+1`]},
    //신코 윈디
    ...
    {createDate:`2022-10-11`, character:`신코 윈디`, eventType:`support`,  cardName: `[///WARNING GATE///] 신코 윈디`, title: `② 게이트여, 열려라!`, choice: [`(선택지 없음)`], effect: [`스피드+10<br>스킬 Pt+15<br>${skill(201052)} 힌트 LV+3<br>신코 윈디의 우정도+5<br>또는<br>스피드+5<br>스킬 Pt+10<br>신코 윈디의 우정도+5`]},
    {createDate:`2022-10-11`, character:`신코 윈디`, eventType:`support`,  cardName: null, title: `덥석, 돌격!`, choice: [`내 말대로 됐군`, `패배를 인정해?`], effect: [`스킬 Pt+15<br>신코 윈디의 우정도+5`, `스피드+3<br>${skill(201072)} 힌트 LV+1<br>신코 윈디의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`심볼리 루돌프`, eventType:`support`, cardName: `[트레센 학원] 심볼리 루돌프`, title: `학생회장의 마음`, choice: [`고마워, 덕분에 비 오는 날에도 안심이야`, `학원을 위해 수고가 많네`], effect: [`${skill(200232)} 힌트 LV+1`, `스태미나+15`]},
    //심볼리 크리스 에스
    //아그네스 디지털
    {createDate:`2022-08-13`, character:`아그네스 디지털`, eventType:`support`, cardName: null, title: `감동적인 걸 위해서라면 빗속이라도!`, choice: [`무리하다가 감기 걸린다`, `진지하구나!`], effect: [`아그네스 디지털의 우정도+5<br>${skill(200232)} 힌트 LV+1`, `${skill(200162)} 힌트 LV+1<br>아그네스 디지털의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`아그네스 디지털`, eventType:`support`, cardName: `[디지털 충전 중+] 아그네스 디지털`, title: `② 우마무스메를 향한 사랑은 영원해요!`, choice: [`(선택지 없음)`], effect: [`스피드+5<br>파워+10<br>${skill(200821)} 힌트 LV+1`]},
    //아그네스 타키온
    ...
    {createDate:`2022-08-13`, character:`아그네스 타키온`, eventType:`support`, cardName: null, title: `검증 필요・타인의 개입으로 촉발된 우발성`, choice: [`주법`, `판단력`], effect: [`아그네스 타키온의 우정도+5<br>${skill(201542)} 힌트 LV+1`, `지능+10<br>아그네스 타키온의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`아그네스 타키온`, eventType:`support`, cardName: `[생체 A에 관한 실험적 연구] 아그네스 타키온`, title: `② Report『미정 (휴식도 중요)』`, hiddenTag: `리포트`, choice: [`(선택지 없음)`], effect: [`지능+10<br>스킬 Pt+15<br>${skill(200831)} 힌트 LV+1`]},
    //아이네스 후진
    {createDate:`2022-08-13`, character:`아이네스 후진`, eventType:`support`, cardName: null, title: `술래잡기야!`, choice: [`느긋하게 즐긴다`, `전력을 다해 논다!`], effect: [`체력+10<br>스피드+5<br>아이네스 후진의 우정도+5`, `${skill(200542)} 힌트 LV+1<br>아이네스 후진의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`아이네스 후진`, eventType:`support`, cardName: `[뛰쳐나와, 반짝여라] 아이네스 후진`, title: `③ 목표는 반짝이는 순간!`, choice: [`(선택지 없음)`], effect: [`성공 시 :<br>체력-10<br>근성+20<br>지능+5<br>${skill(201281)} 힌트 LV+3<br>또는<br>체력-10<br>근성+10<br>지능+5<br>${skill(201281)} 힌트 LV+1<br>실패 시 :<br>체력-10<br>근성+10<br>${skill(201282)} 힌트 LV+1`]},
    //애스턴 마짱
    //야마닌 제퍼
    //야에노 무테키
    ...
    {createDate:`2022-08-19`, character:`야에노 무테키`, eventType:`support`, cardName: `[누르고 참으려 해도 계속 불타는 것] 야에노 무테키`, title: `② 이성의 식 VS 난폭의 식`, choice: [`마음껏 먹어 치워!`, `각자 맞는 양을 먹는 게 더 좋아…`], effect: [`체력+10<br>스킬 Pt+10<br>야에노 무테키의 우정도+5`, `체력+10<br>지능+10<br>스킬 Pt+10<br>${skill(201661)} 힌트 LV+3<br>※다음 이벤트가 발생하지 않음`]},
    {createDate:`2022-08-19`, character:`야에노 무테키`, eventType:`support`, cardName: `[누르고 참으려 해도 계속 불타는 것] 야에노 무테키`, title: `③ 야에노 무테키 연가지옥변`, choice: [`(선택지 없음)`], effect: [`체력-10<br>스피드+5<br>스태미나+5<br>파워+5<br>${skill(200461)} 힌트 LV+3<br><br>체력-10<br>스피드+5<br>스태미나+5<br>${skill(200461)} 힌트 LV+1`]},
    ...
    {createDate:`2022-08-19`, character:`야에노 무테키`, eventType:`support`, cardName: null, title: `아아, 지키고 싶어…!`, choice: [`혹독하게 수행하는 것 같은 표정이었어`, `재미있는 면도 있구나`], effect: [`스태미나+10<br>파워+10`, `${skill(201112)} 힌트 LV+1`]},
    //어드마이어 베가
    //에어 그루브
    ...
    {createDate:`2022-08-13`, character:`에어 그루브`, eventType:`support`, cardName: null, title: `준엄하고도 은혜롭게`, choice: [`항상 엄하게 대해?`, `상대를 잘 관찰하고 있구나`], effect: [`에어 그루브의 우정도+5<br>${skill(200502)} 힌트 LV+1`, `체력+10<br>지능+10`]},
    ...
    {createDate:`2022-08-13`, character:`에어 그루브`, eventType:`support`, cardName: `[부회장의 일침] 에어 그루브`, title: `② 떡갈나무에 피어라`, choice: [`(선택지 없음)`], effect: [`체력-10<br>파워+5<br>근성+5<br>${skill(200372)} 힌트 LV+3<br>에어 그루브의 우정도+5<br>또는<br>체력-20<br>파워+5<br>근성+5<br>${skill(200372)} 힌트 LV+1<br>에어 그루브의 우정도+5`]},
    //에어 샤커
    ...
    {createDate:`2022-08-13`, character:`에어 샤커`, eventType:`support`, cardName: null, title: `//꼭 가지고 싶다`, choice: [`본인한테 맞는 수단을 찾아보는 건 어때?`, `직접 손에 넣어야지`], effect: [`에어 샤커의 우정도+5<br>${skill(200472)} 힌트 LV+1`, `체력 최대치+4<br>근성+5<br>에어 샤커의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`에어 샤커`, eventType:`support`, cardName: `[7cm의 너머로] 에어 샤커`, title: `③ 내가 최강`, choice: [`(선택지 없음)`], effect: [`스태미너+5<br>지능+10<br>${skill(200731)} 힌트 LV+1`]},
    //에이신 플래시
    {createDate:`2022-08-13`, character:`에이신 플래시`, eventType:`support`, cardName: null, title: `예상 밖의 대응`, choice: [`아예 직접 만드는 건 어떨까?`, `다른 가게를 찾아보는 건 어떨까?`], effect: [`근성+10<br>에이신 플래시의 우정도+5`, `${skill(200292)} 힌트 LV+1<br>에이신 플래시의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`에이신 플래시`, eventType:`support`, cardName: `[0500 · 정각대로] 에이신 플래시`, title: `② 좋은 친구로서`, choice: [`(선택지 없음)`], effect: [`체력+20<br>${skill(200512)} 힌트 LV+1`]},
    //엘 콘도르 파사
    {createDate:`2022-08-13`, character:`엘 콘도르 파사`, eventType:`support`, cardName: null, title: `시크릿 노트!`, choice: [`엘 식 파워 트레이닝 메뉴`, `맑은 날 레이스에서 달리는 요령`], effect: [`파워+10<br>엘 콘도르 파사의 우정도+5`, `${skill(200212)} 힌트 LV+1<br>엘 콘도르 파사의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`엘 콘도르 파사`, eventType:`support`, cardName: `[패션 챔피오나!] 엘 콘도르 파사`, title: `② 국물이 중요해!!`, choice: [`그래, 너만의 맛이야!`, `아니, 조리법이지!`], effect: [`체력+30<br>엘 콘도르 파사의 우정도+5`, `엘 콘도르 파사의 우정도+5<br>연속 이벤트 종료<br>${skill(200562)} 힌트 LV+1`]},
    {createDate:`2022-08-13`, character:`엘 콘도르 파사`, eventType:`support`, cardName: `[패션 챔피오나!] 엘 콘도르 파사`, title: `③ 루차도라・엘!!`, choice: [`(선택지 없음)`], effect: [`파워+10<br>${skill(200721)} 힌트 LV+1`]},
    //오구리 캡
    ...
    {createDate:`2022-08-13`, character:`오구리 캡`, eventType:`support`, cardName: null, title: `인파가 붐비는 곳은 힘들어…`, choice: [`흐름에 휩쓸리지 않도록 버티며 나아가자`, `흐름을 지켜보고 나아가자`], effect: [`파워+5<br>스킬 Pt+15`, `${skill(200042)} 힌트 LV+1`]},
    ...
    {createDate:`2022-08-13`, character:`오구리 캡`, eventType:`support`, cardName: `[『사랑받는 존재가 되어다오』] 오구리 캡`, title: `② 정말로 응해야 하는 건…`, choice: [`그때는 어른을 의지해`, `마법의 말을 가르쳐줄게`], effect: [`파워+5<br>스킬 Pt+10<br>오구리 캡의 우정도+5<br>${skill(200562)} 힌트 LV+1`, `스태미나+5<br>스킬 Pt+10<br>오구리 캡의 우정도+5<br>${skill(200612)} 힌트 LV+1`]},
    {createDate:`2022-08-13`, character:`오구리 캡`, eventType:`support`, cardName: `[『사랑받는 존재가 되어다오』] 오구리 캡`, title: `③ 내가 하고 싶은 말은…`, choice: [`지금의 너라면 문제없어`, `넌 어떻게 하고 싶어?`], effect: [`성공 시 :<br>파워+15<br>근성+10<br>스킬 Pt+15<br>${skill(200701)} 힌트 LV+3<br>실패 시 :<br>파워+10<br>근성+5<br>스킬 Pt+10<br>${skill(200701)} 힌트 LV+1<br>오구리 캡의 우정도+5`, `체력+30`]},
    //원더 어큐트
    //위닝 티켓
    {createDate:`2022-08-13`, character:`위닝 티켓`, eventType:`support`, cardName: null, title: `전・력・경・주!!`, choice: [`손잡이 지름길이야!`, `상대의 움직임을 예상해 보는 건 어때?`], effect: [`위닝 티켓의 우정도+5<br>${skill(201392)} 힌트 LV+1`, `스킬 Pt+30<br>위닝 티켓의 우정도+5`]},
    ...
    {createDate:`2022-08-19`, character:`위닝 티켓`, eventType:`support`, cardName: `[꿈은 정말로 이루어지는구나!] 위닝 티켓`, title: `③ 도전! 꿈은 이루기 위해 있다!`, choice: [`(선택지 없음)`], effect: [`체력-30<br>스태미나+5<br>파워+5<br>${skill(200511)} 힌트 LV+2`]},
    ...
    {createDate:`2022-08-13`, character:`위닝 티켓`, eventType:`support`, cardName: `[B · N · Winner!!] 위닝 티켓`, title: `③ We are BNW!!`, hiddenTag: `위 어 비엔더블유`, choice: [`(선택지 없음)`], effect: [`근성+10<br>${skill(200601)} 힌트 LV+1`]},
    ...
    {createDate:`2022-11-17`, character:`위닝 티켓`, eventType:`support`,  cardName: `[전력! 탠트럼!] 위닝 티켓`, title: `② 티케조☆프렌드십!`, choice: [`웃어 웃어!`, `일단 어디서 진정 좀 할래?`], effect: [`${skill(201412)} 힌트 LV+1<br>스태미나+3<br>근성+3<br>위닝 티켓의 우정도+10`, `${skill(200272)} 힌트 LV+3<br>체력+25<br>위닝 티켓의 우정도-5<br>연속 이벤트 종료`]},
    {createDate:`2022-11-17`, character:`위닝 티켓`, eventType:`support`,  cardName: `[전력! 탠트럼!] 위닝 티켓`, title: `③ 티케조☆나이트 피버!`, choice: [`(선택지 없음)`], effect: [`${skill(201401)} 힌트 LV+1<br>스피드+8<br>스태미나+8<br>근성+8`]},
    //유키노 비진
    ...
    {createDate:`2022-08-13`, character:`유키노 비진`, eventType:`support`, cardName: `[고향 직송 응원!] 유키노 비진`, title: `③ 저, 이기고 싶어요!`, choice: [`멋있는 모습을 보여주자!`, `특훈의 성과를 보여주자!`], effect: [`컨디션 상승<br>${skill(200491)} 힌트 LV+1<br>유키노 비진의 우정도+5`, `파워+3<br>근성+3<br>지능+3<br>${skill(200491)} 힌트 LV+1<br>유키노 비진의 우정도+5`]},
    {createDate:`2022-08-13`, character:`유키노 비진`, eventType:`support`, cardName: null, title: `'시티스폿'을 목표로`, choice: [`이 지도를 보면, 현재 위치와 목적지는…`, `지도 앱을 쓰면 편해`], effect: [`체력-10<br>컨디션 상승<br>근성+10<br>유키노 비진의 우정도+5`, `${skill(200342)} 힌트 LV+1<br>유키노 비진의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`이쿠노 딕터스`, eventType:`support`, cardName: null, title: `이쿠노식 매니지먼트론`, choice: [`내 스케줄도 봐줄래?`, `비법 좀 가르쳐줘`], effect: [`스태미나+20<br>이쿠노 딕터스의 우정도+5`, `이쿠노 딕터스의 우정도+5<br>${skill(200781)} 힌트 LV+1`]},
    ...
    {createDate:`2022-08-13`, character:`이쿠노 딕터스`, eventType:`support`, cardName: `[준비운동은 게을리하지 말 것] 이쿠노 딕터스`, title: `② 이쿠노식 서포트 메서드`, choice: [`심폐기능을 단련해서 도주에 특화!`, `다릿심을 강화하는 추입으로!`], effect: [`지능+15<br>${skill(200791)} 힌트 LV+3<br>이쿠노 딕터스의 우정도+5`, `지능+15<br>이쿠노 딕터스의 우정도+5<br>${skill(200821)} 힌트 LV+3`]},
    ...
    {createDate:`2023-01-10`, character:`이쿠노 딕터스`, eventType:`support`,  cardName: `[마음과 기반은 따뜻하게] 이쿠노 딕터스`, title: `② U려되는 사태?`, hiddenTag: `우려되는`, choice: [`얘기한 내용에 자신은 있어?`, `나한테도 편자를 만들어 줄 수 있어?`], effect: [`근성+15<br>이쿠노 딕터스의 우정도+5<br>${skill(200502)} 힌트 LV+1`, `체력+20<br>스피드+10<br>스킬 Pt+10<br>※ 다음 이벤트가 발생하지 않음`]},
    {createDate:`2023-01-10`, character:`이쿠노 딕터스`, eventType:`support`,  cardName: `[마음과 기반은 따뜻하게] 이쿠노 딕터스`, title: `③ U정`, hiddenTag: `우정`, choice: [`(선택지 없음)`], effect: [`스태미나+20<br>근성+10<br>스킬 Pt+10<br>${skill(201431)} 힌트 LV+1`]},
    //젠노 롭 로이
    ...
    {createDate:`2022-08-19`, character:`젠노 롭 로이`, eventType:`support`, cardName: `[추천하는 책이 있어요!] 젠노 롭 로이`, title: `② 언젠가, 『이야기』의 주인공이`, choice: [`(선택지 없음)`], effect: [`스태미나+10<br>지능+10<br>${skill(201442)} 힌트 LV+1`]},
    ...
    {createDate:`2022-08-19`, character:`젠노 롭 로이`, eventType:`support`, cardName: null, title: `맡겨진 이야기`, choice: [`도서부원한테 물어보는 게 좋겠네`, `그 책은 무슨 스토리인데?`], effect: [`스태미나+10<br>지능+10<br>젠노 롭 로이의 우정도+5`, `${skill(201102)} 힌트 LV+1<br>젠노 롭 로이의 우정도+5`]},
    ...
    {createDate:`2023-01-18`, character:`젠노 롭 로이`, eventType:`support`, cardName: `[마력을 받은 영웅] 젠노 롭 로이`, title: `② 독서 소녀와 비밀의 작전회의`, choice: [`매력적인 선전?`, `분위기를 좀 더 살린다든지…`, `의상에도 공들이는 게 좋겠어!`], effect: [`스태미나+5<br>젠노 롭 로이의 우정도+5<br>${skill(200012)} 힌트 LV+2`, `스피드+5<br>젠노 롭 로이의 우정도+5<br>${skill(200012)} 힌트 LV+2`, `지능+30<br>젠노 롭 로이의 우정도+5`]},
    ...
    {createDate:`2022-12-19`, character:`카시모토 리코`, eventType:`support`,  cardName: null, title: `③ 기뻐하는 얼굴을 떠올리며`, choice: [`『대용량 벌꿀우유』는  어떤가요!`, `『우마스타 감성 젤리 소다』는 어떤가요!`], effect: [`체력+20<br>컨디션 상승<br>스태미나+10<br>근성+5<br>카시모토 리코의 우정도+5<br>※ 서포트 효과에 따라 수치 변동`, `컨디션 상승<br>스킬 Pt+30<br>카시모토 리코의 우정도+5<br>※ 서포트 효과에 따라 수치 변동`]},
    {createDate:`2022-12-19`, character:`카시모토 리코`, eventType:`support`,  cardName: null, title: `④ 위해주는 마음과 당혹감`, choice: [`(선택지 없음)`], effect: [`체력+20<br>컨디션 상승<br>스피드+10<br>스태미나+5<br>파워+5<br>카시모토 리코의 우정도+5<br>※ 서포트 효과에 따라 수치 변동`]},
    {createDate:`2022-12-19`, character:`카시모토 리코`, eventType:`support`,  cardName: null, title: `가끔은 이런 시간도`, choice: [`(선택지 없음)`], effect: [`스태미나+4<br>근성+4<br>스킬 Pt+6<br>※ 카시모토 리코와의 인연 게이지가 최대 상태일 때<br>※ 카시모토 리코와의 외출 이벤트를 모두 진행하지 않은 경우`]},
    {createDate:`2022-12-19`, character:`카시모토 리코`, eventType:`support`,  cardName: null, title: `둘도 없이 소중한 만남에`, choice: [`(선택지 없음)`], effect: [`스태미나+15<br>근성+15<br>스킬 Pt+20<br>※ 카시모토 리코와의 인연 게이지가 최대 상태일 때<br>※ 카시모토 리코와의 외출 이벤트를 모두 진행`]},
    {createDate:`2022-12-19`, character:`카시모토 리코`, eventType:`support`,  cardName: null, title: `리코와의 인연・과오를 반복하지 않도록`, choice: [`(선택지 없음)`], effect: [`컨디션 상승<br>스태미나+12<br>근성+6<br>${skill(201631)} 힌트 LV+3<br>카시모토 리코의 우정도+5<br>※ 서포트 효과에 따라 수치 변동`]},
    {createDate:`2022-12-19`, character:`카시모토 리코`, eventType:`support`,  cardName: null, title: `수고하셨습니다`, choice: [`(선택지 없음)`], effect: [`※ 함께 트레이닝 할 경우 랜덤하게 이벤트 발생<br>랜덤하게 컨디션 상승<br>스태미나+3<br>카시모토 리코의 우정도+5`]},
    {createDate:`2022-12-19`, character:`카시모토 리코`, eventType:`support`,  cardName: null, title: `의외의 일면`, choice: [`일단 체력을 키워보는 게 어떨까요?`, `반복해서 도전해봅시다!`, `오늘은 좀 바빠서…`], effect: [`성공 시 :<br>체력+18~19<br>컨디션 상승<br>스태미나+12~13<br>${skill(200462)} 힌트 LV+5<br>카시모토 리코의 우정도+12<br>카시모토 리코와 외출 가능<br>※ 서포트 효과에 따라 수치 변동<br>실패 시 :<br>${skill(200272)} 힌트 LV+5<br>카시모토 리코의 우정도-10<br>카시모토 리코와 외출 불가`, `컨디션 상승<br>근성+18<br>카시모토 리코의 우정도+5<br>카시모토 리코와 외출 가능<br>※ 서포트 효과에 따라 수치 변동`, `카시모토 리코의 우정도-10<br>※이후 함께 외출 불가<br>${skill(201641)} 힌트 LV+3`]},
    {createDate:`2022-12-19`, character:`카시모토 리코`, eventType:`support`,  cardName: null, title: `일꾼 카시모토 리코`, choice: [`(선택지 없음)`], effect: [`컨디션 상승+1<br>스태미나+6<br>근성+6<br>카시모토 리코의 우정도+5`]},
    {createDate:`2022-12-19`, character:`카시모토 리코`, eventType:`support`,  cardName: null, title: `카시모토류, 정리술`, choice: [`쓰레기 버리기를 부탁합니다`, `서류 정리를 부탁합니다`], effect: [`스태미나+18<br>카시모토 리코의 우정도+5<br>※ 서포트 효과에 따라 수치 변동`, `근성+18<br>카시모토 리코의 우정도+5<br>※ 서포트 효과에 따라 수치 변동`]},
    {createDate:`2022-12-19`, character:`카시모토 리코`, eventType:`support`,  cardName: `[철저한 관리주의] 카시모토 리코`, title: `⑤ 속마음을 조금만`, choice: [`(선택지 없음)`], effect: [`성공 시 :<br>체력+32<br>컨디션 상승<br>스태미나+13<br>근성+13<br>${skill(200371)} 힌트 LV+3<br>카시모토 리코의 우정도+5<br>실패 시 :<br>체력+32<br>컨디션 상승<br>스태미나+6<br>근성+6<br>${skill(200371)} 힌트 LV+1<br>카시모토 리코의 우정도+5<br>`]},
    //카와카미 프린세스
    {createDate:`2022-09-16`, character:`카와카미 프린세스`, eventType:`support`,  cardName: null, title: `프린세스, 도주!`, choice: [`다음은 술래 교대!`, `핸디캡을 좀 주는 게 어때?`], effect: [`체력+10<br>카와카미 프린세스의 우정도+5`, `${skill(200732)} 힌트LV+1<br>카와카미 프린세스의 우정도+5`]},
    ...
    {createDate:`2022-09-16`, character:`카와카미 프린세스`, eventType:`support`,  cardName: `[신부라면!!] 카와카미 프린세스`, title: `① 조신하게! 호쾌하게!`, choice: [`『공주된 자의 포즈』로`, `『굴하지 않는 자의 포즈』로?`], effect: [`컨디션 상승<br>스피드+5<br>카와카미 프린세스의 우정도+5`, `${skill(201152)} 힌트 LV+1<br>스킬 Pt+10<br>카와카미 프린세스의 우정도+5`]},
    ...
    {createDate:`2022-09-16`, character:`카와카미 프린세스`, eventType:`support`,  cardName: `[신부라면!!] 카와카미 프린세스`, title: `③ 공격해라! 공주님 로드!`, choice: [`분명 왕자님이 먼저 나타날 거야`, `너 자신이 왕자님이 될 가능성도 있어`], effect: [`${skill(200451)} 힌트 LV+1<br>스피드+15<br>근성+15<br>카와카미 프린세스의 우정도+5`, `체력+25<br>스킬 Pt+25`]},
    //케이에스 미라클
    //코파노 리키
    //키류인 아오이
    ...
    {createDate:`2022-08-13`, character:`키류인 아오이`, eventType:`support`, cardName: `[함께 같은 길을!] 키류인 아오이`, title: `⑤ 꿈을 계속해서 쫓는 한`, choice: [`(선택지 없음)`], effect: [`스태미너+6<br>스킬 Pt+19<br>키류인 아오이의 우정도+5<br>랜덤으로<br>${skill(200831)} 힌트 LV+1<br>또는<br>스태미너+6<br>파워+6<br>근성+6<br>스킬 Pt+58<br>${skill(200831)} 힌트 LV+3<br>키류인 아오이의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`키류인 아오이`, eventType:`support`, cardName: null, title: `아오이와의 인연・좋은 지도자가 되어라`, choice: [`(선택지 없음)`], effect: [`※ 키류인 아오이와 외출할 수 있는 상태이면 클래식 급 1월 전반에 이벤트 발생<br>컨디션 상승<br>지능+15<br>스킬 Pt+15<br>${skill(201621)} 힌트 LV+3<br>키류인 아오이의 우정도+5`]},
    {createDate:`2022-08-13`, character:`키류인 아오이`, eventType:`support`, cardName: null, title: `취미를 찾아서`, choice: [`좋아합니다!!`, `특별히......`], effect: [`체력+20~28<br>컨디션 상승<br>스킬 Pt+15~18<br>키류인 트레이너의 우정도+5<br>키류인 트레이너와 외출 가능<br>※ 서포트 효과에 따라 수치 변동<br>※발동 조건 : 우정도 초록색 이상`, `컨디션 하락<br>키류인 트레이너의 우정도-5<br>${skill(200272)} 힌트 LV+1`]},
    ...
    {createDate:`2022-08-13`, character:`키타산 블랙`, eventType:`support`, cardName: `[다가오는 열기에 떠밀려] 키타산 블랙`, title: `② 정을 베푸는 건 남을 위해서만이 아니야`, choice: [`빨리 나아야겠다`, `건강함에서 지고 들어갈 순 없지!`], effect: [`체력+10<br>컨디션 상승<br>키타산 블랙의 우정도+5`, `스피드+5~10<br>${skill(200362)} 힌트 LV+1~3<br>키타산 블랙의 우정도+5`]},
    {createDate:`2022-08-13`, character:`키타산 블랙`, eventType:`support`, cardName: `[다가오는 열기에 떠밀려] 키타산 블랙`, title: `③ 둘이서 가는 이 꽃길`, choice: [`(선택지 없음)`], effect: [`스피드+10<br>파워+10<br>${skill(200331)} 힌트 LV+3<br>키타산 블랙의 우정도+5<br>또는<br>스피드+5<br>파워+5<br>${skill(200331)} 힌트 LV+1<br>키타산 블랙의 우정도+5`]},
    ...
    //킹 헤일로
    {createDate:`2022-08-13`, character:`킹 헤일로`, eventType:`support`, cardName: null, title: `조언할 권리를 주겠어!`, choice: [`최신 근성론에 대하여 토론한다`, `스퍼트 타이밍에 대하여 이야기한다`], effect: [`근성+10<br>지능+5<br>킹 헤일로의 우정도+5`, `${skill(200512)} 힌트 LV+1<br>킹 헤일로의 우정도+5`]},
    ...
    {createDate:`2022-10-22`, character:`킹 헤일로`, eventType:`support`,  cardName: `[오늘 밤, 왈츠를 타고] 킹 헤일로`, title: `③ 무도회의 기라성`, choice: [`(선택지 없음)`], effect: [`성공 시 :<br>체력-10<br>파워+25<br>${skill(200671)} 힌트 LV+3<br>실패 시 :<br>체력-10<br>파워+20<br>${skill(200672)} 힌트 LV+3`]},
    //타니노 김렛
    //타마모 크로스
    {createDate:`2022-08-13`, character:`타마모 크로스`, eventType:`support`, cardName: null, title: `질 수 없는 싸움!`, choice: [`인파를 파악해!`, `라이벌을 잘 관찰하자`], effect: [`타마모 크로스의 우정도+5<br>${skill(200482)} 힌트 LV+1`, `스태미나+5<br>지능+5<br>타마모 크로스의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`타마모 크로스`, eventType:`support`, cardName: `[하늘도 갈라버리는 번개 소녀!] 타마모 크로스`, title: `③ 가난함은 친구다!`, choice: [`(선택지 없음)`], effect: [`${skill(200591)} 힌트 LV+1`]},
    {createDate:`2023-01-18`, character:`타마모 크로스`, eventType:`support`, cardName: `[붙어보자, 할로윈 나이트!] 타마모 크로스`, title: `① 미라 헌트 ~코미디를 타파하라!~`, choice: [`재밌었어!`, `무섭단 느낌은 안 들었는데…`], effect: [`파워+10<br>타마모 크로스의 우정도+5`, `체력+20<br>스피드+10<br>연속 이벤트 종료<br>${skill(200162)} 힌트 LV+1`]},
    ...
    {createDate:`2023-01-18`, character:`타마모 크로스`, eventType:`support`, cardName: `[붙어보자, 할로윈 나이트!] 타마모 크로스`, title: `③ 미라 헌트 ~가장 무서운 스위트 마미~`, choice: [`(선택지 없음)`], effect: [`스피드+5<br>파워+5<br>${skill(201411)} 힌트 LV+1<br>또는<br>스피드+15<br>파워+15<br>${skill(201411)} 힌트 LV+3`]},
    //타이키 셔틀
    {createDate:`2022-08-13`, character:`타이키 셔틀`, eventType:`support`, cardName: `[트레센 학원] 타이키 셔틀`, title: `Oh! Tonight Party☆`, hiddenTag: `오 투나잇 파티`, choice: [`멀리 돌아서 전력 대시다!`, `집단을 헤친다는 이미지로 달리자!`], effect: [`체력-10<br>스피드+5<br>파워+10`, `${skill(200582)} 힌트 LV+1`]},
    ...
    {createDate:`2022-12-10`, character:`토센 조던`, eventType:`support`,  cardName: `[nail on Turf] 토센 조던`, title: `② 소질이 있어야만 가능한 네일이지`, choice: [`멋만 부리는 게 아니라 도움도 되는 거구나`, `승부에 진심인 점은 멋지다고 생각해`], effect: [`성공 시 :<br>체력+10<br>${skill(200462)} 힌트 LV+3<br>토센 조던의 우정도+5<br>실패 시 :<br>${skill(200462)} 힌트 LV+1`, `체력-5<br>스태미나+20<br>토센 조던의 우정도+5`]},
    //토카이 테이오
    {createDate:`2022-08-13`, character:`토카이 테이오`, eventType:`support`, cardName: null, title: `나의 무기`, choice: [`전부 할 수 있게 되면 멋있겠네!`, `지금도 충분히 멋진 무기를 갖고 있어.`], effect: [`컨디션 상승<br>근성+10<br>토카이 테이오의 우정도+5`, `${skill(201312)} 힌트 LV+1<br>토카이 테이오의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`토카이 테이오`, eventType:`support`, cardName: `[꿈은 내걸으라고 있는 거야!] 토카이 테이오`, title: `③ 전설의 일막`, choice: [`(선택지 없음)`], effect: [`체력+10<br>스피드+5<br>${skill(200371)} 힌트 LV+1<br>토카이 테이오의 우정도+7`]},
    {createDate:`2022-12-30`, character:`토카이 테이오`, eventType:`support`,  cardName: `[두 개의 노블 라이트] 토카이 테이오`, title: `① 라이벌과 투샷`, choice: [`(선택지 없음)`], effect: [`파워+10<br>토카이 테이오의 우정도+5`]},
    {createDate:`2022-12-30`, character:`토카이 테이오`, eventType:`support`,  cardName: `[두 개의 노블 라이트] 토카이 테이오`, title: `② 가십 광상곡`, choice: [`중요한 승부라면 아껴두자`, `판정은 맡겨줘`], effect: [`체력+10<br>컨디션 상승<br>토카이 테이오의 우정도+5`, `체력-10<br>파워+15<br>스킬 Pt+20<br>토카이 테이오의 우정도+5<br>※ 다음 이벤트가 발생하지 않음`]},
    {createDate:`2022-12-30`, character:`토카이 테이오`, eventType:`support`,  cardName: `[두 개의 노블 라이트] 토카이 테이오`, title: `③ 등불은 미래로 빛난다`, choice: [`(선택지 없음)`], effect: [`${skill(200761)} 힌트 LV+1<br>스태미나+7<br>파워+7<br>토카이 테이오의 우정도+5`]},
    //트윈 터보
    {createDate:`2022-08-13`, character:`트윈 터보`, eventType:`support`, cardName: null, title: `뜨거워지기 시작했어!`, choice: [`쉬운 곡을 해서 실수를 줄이는 건 어때?`, `최고 난이도에 도전해서 점수를 따자!`], effect: [`체력+15<br>트윈 터보의 우정도+5`, `트윈 터보의 우정도+5<br>${skill(200532)} 힌트 LV+1`]},
    ...
    {createDate:`2022-08-13`, character:`트윈 터보`, eventType:`support`, cardName: `[터보 엔진 전개 선언!] 트윈 터보`, title: `③ 터보는 강하다니까!`, choice: [`터보 엔진 전개다!`, `숨을 돌려!`], effect: [`성공 시 :<br>체력-10<br>스피드+25<br>${skill(200531)} 힌트 LV+3<br>실패 시 :<br>체력-10<br>스피드+5<br>${skill(200532)} 힌트 LV+3`, `체력+15<br>${skill(200692)} 힌트 LV+1`]},
    {createDate:`2022-12-30`, character:`트윈 터보`, eventType:`support`,  cardName: `[모여서 콘스텔레이션] 트윈 터보`, title: `① 『선전』시동!!`, choice: [`……선전, 해보는 건 어때?`, `강요하면 안 돼`], effect: [`체력-5<br>근성+15<br>트윈 터보의 우정도+5`, `체력+20<br>트윈 터보의 우정도-5<br>연속 이벤트 종료`]},
    {createDate:`2022-12-30`, character:`트윈 터보`, eventType:`support`,  cardName: `[모여서 콘스텔레이션] 트윈 터보`, title: `② 『선전』전개!!`, choice: [`(선택지 없음)`], effect: [`체력-10<br>스피드+7<br>파워+7<br>트윈 터보의 우정도+5`]},
    {createDate:`2022-12-30`, character:`트윈 터보`, eventType:`support`,  cardName: `[모여서 콘스텔레이션] 트윈 터보`, title: `③ 『선전』최고!!`, choice: [`(선택지 없음)`], effect: [`${skill(200721)} 힌트 LV+3<br>체력-10<br>근성+15<br>트윈 터보의 우정도+5<br>또는<br>${skill(200722)} 힌트 LV+3<br>체력-10<br>근성+10<br>트윈 터보의 우정도+5`]},
    //티엠 오페라 오
    ...
    {createDate:`2022-08-13`, character:`티엠 오페라 오`, eventType:`support`, cardName: `[트레센 학원] 티엠 오페라 오`, title: `유한한 시간을 초월하여`, choice: [`한정된 시간에 최선을 다하자`, `틀에 얽매이지 않는 사고방식은 중요하지`], effect: [`체력+10<br>스킬 Pt+15`, `${skill(200142)} 힌트 LV+1`]},
    //파인 모션
    ...
    {createDate:`2022-08-13`, character:`파인 모션`, eventType:`support`, cardName: null, title: `추억 클로버`, choice: [`최종 코너`, `마지막 직선`], effect: [`파인 모션의 우정도+5<br>${skill(200332)} 힌트 LV+1`, `근성+15<br>파인 모션의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`파인 모션`, eventType:`support`, cardName: `[감사는 손끝까지 담아서] 파인 모션`, title: `③ 멋진♪ 레이스 하기 좋은 날`, choice: [`(선택지 없음)`], effect: [`성공 시 :<br>체력-10<br>근성+5<br>지능+10<br>스킬 Pt+15<br>${skill(200581)} 힌트 LV+1~3<br>실패 시 :<br>체력-10<br>근성+5<br>지능+5<br>스킬 Pt+5<br>${skill(200582)} 힌트 LV+1`]},
    {createDate:`2023-01-10`, character:`파인 모션`, eventType:`support`,  cardName: `[GRMA 라멘♪] 파인 모션`, title: `① 둘 다 일상이지~`, choice: [`(선택지 없음)`], effect: [`체력+15<br>파워+5<br>스킬 Pt+10`]},
    {createDate:`2023-01-10`, character:`파인 모션`, eventType:`support`,  cardName: `[GRMA 라멘♪] 파인 모션`, title: `② 너도 클로버야♪`, choice: [`(선택지 없음)`], effect: [`스킬 Pt+20<br>${skill(200732)} 힌트 LV+2`]},
    //하루 우라라
    {createDate:`2022-08-13`, character:`하루 우라라`, eventType:`support`, cardName: null, title: `우라랑☆복병 대시!`, choice: [`복병의 제대로 된 의미를 알려준다`, `쉬는 편이 좋다고 말한다`], effect: [`${skill(200302)} 힌트 LV+1`, `컨디션 상승<br>체력+10<br>하루 우라라의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`하루 우라라`, eventType:`support`, cardName: `[화창~한 휴일] 하루 우라라`, title: `③ 모두의 응원으로 힘낼게!`, choice: [`(선택지 없음)`], effect: [`체력+15<br>${skill(200481)} 힌트 LV+1<br>하루 우라라의 우정도+5`]},
    //하야카와 타즈나
    {createDate:`2022-08-13`, character:`하야카와 타즈나`, eventType:`support`, cardName: `[트레센 학원에 어서 오세요!] 하야카와 타즈나`, title: `⑤ 재충전 서프라이즈`, choice: [`(선택지 없음)`], effect: [`체력+56<br>스킬 Pt+40<br>컨디션 2단계 상승<br>${skill(200431)} 힌트 LV+1<br>하야카와 타즈나의 우정도+5<br>또는<br>체력+56<br>스킬 Pt+40<br>컨디션 2단계 상승<br>${skill(200432)} 힌트 LV+1<br>하야카와 타즈나의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`하야카와 타즈나`, eventType:`support`, cardName: null, title: `열정적인 두 사람`, choice: [`더 이야기하고 싶습니다!`, `그럼, 일이 있어서 슬슬...`], effect: [`체력+10~14<br>지능+5~6<br>컨디션 상승<br>하야카와 타즈나의 우정도+5<br>하야카와 타즈나와 외출 가능<br>※ 서포트 효과에 따라 수치 변동<br>※발동 조건 : 우정도 초록색 이상`, `컨디션 하락<br>하야카와 타즈나의 우정도-5<br>${skill(200692)} 힌트 LV+1<br>※ 이후 외출 불가`]},
    ...
    {createDate:`2022-08-13`, character:`하야카와 타즈나`, eventType:`support`, cardName: null, title: `타즈나와의 인연・동경을 맡기고`, choice: [`(선택지 없음)`], effect: [`※ 하야카와 타즈나와 외출할 수 있는 상태이면 클래식 급 1월 전반에 이벤트 발생<br>체력+10<br>컨디션 상승<br>스피드+15<br>${skill(201611)} 힌트 LV+3<br>하야카와 타즈나의 우정도+5`]},
    //홋코 타루마에
    //후지 키세키
    {createDate:`2022-08-13`, character:`후지 키세키`, eventType:`support`, cardName: null, title: `미스디렉션`, choice: [`마지막 코너링 요령`, `달리기 테크닉`], effect: [`후지 키세키의 우정도+5<br>${skill(200582)} 힌트 LV+1`, `스킬 Pt+30<br>후지 키세키의 우정도+5`]},
    ...
    {createDate:`2022-08-13`, character:`후지 키세키`, eventType:`support`, cardName: `[나 참, 어서 와] 후지 키세키`, title: `② 아웃 오브 디스 월드`, choice: [`(선택지 없음)`], effect: [`지능+10<br>스킬 Pt+15<br>${skill(200931)} 힌트 LV+1`]},
    //히시 아마존
    ...
    {createDate:`2022-08-13`, character:`히시 아마존`, eventType:`support`, cardName: `[정점에 서라!] 히시 아마존`, title: `② 언니식 해결법`, choice: [`(선택지 없음)`], effect: [`스피드+10<br>${skill(200632)} 힌트 LV+1`]},
    ...
    {createDate:`2022-08-13`, character:`히시 아마존`, eventType:`support`, cardName: null, title: `히시아마 언니 분투기 ~추입 편~`, choice: [`기백으로 라이벌을 압도한다`, `바깥쪽으로 크게 돌아 치고 나가본다`], effect: [`히시 아마존의 우정도+5<br>${skill(200941)} 힌트 LV+1`, `파워+5<br>스킬 Pt+15<br>히시 아마존의 우정도+5`]},
    //히시 아케보노
    ...
    {createDate:`2022-09-16`, character:`히시 아케보노`, eventType:`support`,  cardName: `[드세요, 퍼스트 Bite!] 히시 아케보노`, title: `③ 당신에게 보노, 나도 보노☆`, choice: [`(선택지 없음)`], effect: [`스태미나+5<br>근성+10<br>${skill(201261)} 힌트 LV+3<br>또는<br>스태미나+5<br>근성+10<br>${skill(201262)} 힌트 LV+3`]},
];